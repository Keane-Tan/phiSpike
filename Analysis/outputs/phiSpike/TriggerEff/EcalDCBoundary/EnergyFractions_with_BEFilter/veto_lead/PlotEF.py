...
def plotHist(bkg,var,year):
	...
	leg = rt.TLegend(0.5,0.75,0.8,0.88)
...
varList = {
	'Jets[0]_muonEnergyFraction_hot':["AK4Jet[0] Muon Energy Fraction"],
	'Jets[0]_electronEnergyFraction_hot':["AK4Jet[0] Electron Energy Fraction"],
	'Jets[0]_photonEnergyFraction_hot':["AK4Jet[0] Photon Energy Fraction"],
	'Jets[0]_neutralHadronEnergyFraction_hot':["AK4Jet[0] Neutral Hadron Energy Fraction"],
	'Jets[0]_chargedHadronEnergyFraction_hot':["AK4Jet[0] Charged Hadron Energy Fraction"],
	'Jets[0]_muonEnergyFraction_nothot':["AK4Jet[0] Muon Energy Fraction"],
	'Jets[0]_electronEnergyFraction_nothot':["AK4Jet[0] Electron Energy Fraction"],
	'Jets[0]_photonEnergyFraction_nothot':["AK4Jet[0] Photon Energy Fraction"],
	'Jets[0]_neutralHadronEnergyFraction_nothot':["AK4Jet[0] Neutral Hadron Energy Fraction"],
	'Jets[0]_chargedHadronEnergyFraction_nothot':["AK4Jet[0] Charged Hadron Energy Fraction"]
}

varSL = ['Jets[0]_muonEnergyFraction','Jets[0]_electronEnergyFraction','Jets[0]_photonEnergyFraction','Jets[0]_neutralHadronEnergyFraction','Jets[0]_chargedHadronEnergyFraction']
