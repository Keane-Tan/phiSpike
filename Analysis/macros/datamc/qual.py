...
def loop(self):
	...
	'DeltaPhi3':["s",100,0,3.14,self.fileID+"; #Delta#phi(j_3, MET); Events"],
	'DeltaPhi4':["s",100,0,3.14,self.fileID+"; #Delta#phi(j_4, MET); Events"]
	}
...
# 		Filling histograms	
		if nFJet >= 2:
			histDict['DeltaPhi2'].Fill(deltaPhi(FJets[1].Phi(),METPhi),CWeight)
		if nFJet >= 3:
			histDict['DeltaPhi3'].Fill(deltaPhi(FJets[2].Phi(),METPhi),CWeight)
		if nFJet >= 4:
			histDict['DeltaPhi3'].Fill(deltaPhi(FJets[3].Phi(),METPhi),CWeight)
