...
#	'Jets[1]_muonEnergyFraction_hot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Muon Energy Fraction; Events"],
#	'Jets[1]_electronEnergyFraction_hot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Electron Energy Fraction; Events"],
#	'Jets[1]_photonEnergyFraction_hot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Photon Energy Fraction; Events"],
#	'Jets[1]_neutralHadronEnergyFraction_hot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Neutral Hadron Energy Fraction; Events"],
#	'Jets[1]_chargedHadronEnergyFraction_hot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Charged Hadron Energy Fraction; Events"],
#	'Jets[1]_muonEnergyFraction_nothot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Muon Energy Fraction; Events"],
#	'Jets[1]_electronEnergyFraction_nothot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Electron Energy Fraction; Events"],
#	'Jets[1]_photonEnergyFraction_nothot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Photon Energy Fraction; Events"],
#	'Jets[1]_neutralHadronEnergyFraction_nothot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Neutral Hadron Energy Fraction; Events"],
#	'Jets[1]_chargedHadronEnergyFraction_nothot':["s",100,0,1.01,self.fileID+";AK4Jet[1] Charged Hadron Energy Fraction; Events"]
	}
...
#		if veto == 1:
#			histDict['Jets[1]_muonEnergyFraction_hot'].Fill(mEF[1],CWeight)
#			histDict['Jets[1]_electronEnergyFraction_hot'].Fill(eEF[1],CWeight)
#			histDict['Jets[1]_photonEnergyFraction_hot'].Fill(pEF[1],CWeight)
#			histDict['Jets[1]_neutralHadronEnergyFraction_hot'].Fill(nhEF[1],CWeight)
#			histDict['Jets[1]_chargedHadronEnergyFraction_hot'].Fill(chEF[1],CWeight)
#		else:
#			histDict['Jets[1]_muonEnergyFraction_nothot'].Fill(mEF[1],CWeight)
#			histDict['Jets[1]_electronEnergyFraction_nothot'].Fill(eEF[1],CWeight)
#			histDict['Jets[1]_photonEnergyFraction_nothot'].Fill(pEF[1],CWeight)
#			histDict['Jets[1]_neutralHadronEnergyFraction_nothot'].Fill(nhEF[1],CWeight)
#			histDict['Jets[1]_chargedHadronEnergyFraction_nothot'].Fill(chEF[1],CWeight)			
